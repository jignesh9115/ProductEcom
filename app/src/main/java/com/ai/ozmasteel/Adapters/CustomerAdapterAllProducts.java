...
public class CustomerAdapterAllProducts extends BaseAdapter {

    Context context;
    ArrayList<AllProductsPOJO> arrayList_AllProductsPOJOS;
    int[] images;

    public CustomerAdapterAllProducts(Context context, ArrayList<AllProductsPOJO> arrayList_AllProductsPOJOS, int[] images) {
...
//                R.drawable.product_020};
        product_image.setImageResource(images[position]);
